...
approved in order to submit the final project. **Commit your initial proposal to your project 3 
git repository.** 

We will do our best to review all initial proposals by end of day Tuesday, December 2nd. For proposals that 
need modifications, we will notify you before class on Tuesday, December 2nd, and you should 
