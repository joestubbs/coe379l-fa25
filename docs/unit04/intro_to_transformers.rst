...
.. note::
  ...
  We'll use a new image, ``jstubbs/coe379l-llm:fa25`` available on the Docker Hub for this unit. 
...
.. code-block:: console 
  ...
  docker run --name nb -it --rm -v $(pwd)/hf_cache:/root/.cache/huggingface  -v $(pwd)/nb-data:/code -p 8888:8888 -d  jstubbs/coe379l-llm:fa25
...
As a result of the two shortcoming above, RNNs have not been able to handle sequences with 10s or 100s of thousands 
of items. 
